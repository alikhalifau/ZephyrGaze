 ...
 * This file demonstrates how to integrate Zephyrgaze with a web frontend
 */

// For React/Vue/Angular applications
export class ZephyrgazeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ZephyrgazeClient(provider, contractAddress);
